...
export default function HeroSection() {
    return (
        <section className="relative min-h-screen pt-24 px-6 md:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center overflow-hidden">
            ...
            >
                ...
                <h1 className="font-display font-bold text-5xl lg:text-7xl leading-[1.1] text-white tracking-tight">
                ...
                <p className="font-sans text-gray-400 text-lg lg:text-xl max-w-xl leading-relaxed">
